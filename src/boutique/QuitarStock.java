 ...
 * @author moai
 */
public class QuitarStock extends javax.swing.JDialog {
    
    Prendas prendasPasadas;

    /**
     * Creates new form QuitarStock
     */
    public QuitarStock(java.awt.Frame parent, boolean modal, Prendas laPrenda) {
        super(parent, modal);
