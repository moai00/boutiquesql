...
public class ModificarStock extends javax.swing.JDialog {
    ...
    private Prendas prendasPasadas;

    public Prendas getPrendasPasadas() {
        return prendasPasadas;
    }

    public void setPrendasPasadas(Prendas prendasPasadas) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (nuevoStock < 0) {
                ...
                if (p.actualizarPrenda(prendasPasadas)) {
